...
def positive_keywords():
    ...
    return [
        "growth", "profit", "gain", "surge", "rise", "bullish",
        "upgrade", "beat", "exceeds", "strong", "positive",
        "success", "breakthrough", "innovative", "record",
        "outperform", "momentum", "rally", "soar", "boost"
    ]
...
def negative_keywords():
    ...
    return [
        "loss", "decline", "drop", "fall", "bearish", "downgrade",
        "miss", "below", "weak", "negative", "concern", "risk",
        "crash", "plunge", "scandal", "fraud", "investigation",
        "layoffs", "bankruptcy", "lawsuit", "warning", "trouble"
    ]
